                                                ...
                                                if titulo_selecionado:
                                                    ...
                                                    while not stopform3:
                                                        ...
                                                        if inputEvent3 in [sg.WIN_CLOSED, '-CANCELAR-']:
                                                            ...
                                                            publicacoes = fc.alterarDetalhesTarefa(inputValues3['novo_titulo'],inputValues3['novo_resumo'],inputValues3['novas_palavras'],autores,inputValues3['nova_data'],inputValues3['novo_doi'],inputValues3['novo_pdf'],inputValues3['novo_url'], BD)
