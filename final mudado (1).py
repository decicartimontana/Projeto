  ...
  ####################################################################################################
            ...
            if BD == None :
                ...
                layout8 = [
                    ...
                    [sg.Button ('Título', size=(20,1),button_color=(claro,escuro),font = ("Cooper Hewitt",12)),sg.Button ('Autor', size=(20,1),button_color=(claro,escuro),font = ("Cooper Hewitt",12)),sg.Button ('Afiliação', size=(20,1),button_color=(claro,escuro),font = ("Cooper Hewitt",12)),sg.Button ('Data de Publicação', size=(20,1),button_color=(claro,escuro),font = ("Cooper Hewitt",12)),sg.Button ('Palavras-chave', size=(20,1),button_color=(claro,escuro),font = ("Cooper Hewitt",12)),sg.Button ('Retornar ao Menu',size=(20,1), font=("Cooper Hewitt", 12), button_color= (claro,tijolo))],      
                ]
                #######
                ...
                while stop8 == False:
                    ...
                    if eventos8 in [sg.WIN_CLOSED, 'Exit'] or eventos8=='Retornar ao Menu':
                        ...
                        layout8 = [
                            ...
                            [sg.InputText(key='-CON-', size=(58,0)), sg.Button('Procurar',  size=(10,1), font=("Baskerville", 12), pad=((9,0),(5,10)), button_color=(claro, escuro))],
                            [sg.Button('OK', button_color=(claro, escuro), font=("Cooper Hewitt", 12)),
                            sg.Button('Sair', button_color=(claro, tijolo), font=("Cooper Hewitt", 12))],
                        ]
